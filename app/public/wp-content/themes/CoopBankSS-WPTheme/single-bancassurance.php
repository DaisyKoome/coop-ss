...
<div class="web-banner" style="background-image: url(<?php echo the_field('account_header_image'); ?>)">
 ...
 <!-- Breadcrumbs -->
        <section id="breadcrumbs">
            <div class="wrapper">
                <ul>
                    ...
                    <?php $terms = get_the_terms( $post->ID , 'insurance' );

					foreach ( $terms as $term ) { ?>
					
					
					<li><a href="<?php echo home_url('/insurance/'); ?><?php echo $term->slug; ?>"><?php echo $term->name; ?></a></li>
  ...
  <!-- End-of-Breadcrumbs -->
        ...
        <div class="other-a grey-background" style="max-width: 1400px;width: 100%;margin: 0 auto;padding: 20px 20px;">
                    <div class="wrapper">
                        <h2 class="section-heading secondary centre">Other Accounts</h2>
            ...
            <div class="other-a visted-p" style="max-width: 1400px;width: 100%;margin: 0 auto;padding: 20px 20px;">
            ...
            <div class="wrapper">
                ...
                <?php 
	    if (get_post_type( $post->ID ) == 'bancassurance' )
