        ...
        <section class="account">
            <div class="wrapper">
                    <div class="tbl">
                        <div class="col left">
                            <div class="caption-menu">
                                <ul>
                                    ...
                                    <li class="active"><a href="<?php echo home_url('/money-transfer/'); ?>" ><span>Money Transfer</span></a></li>
                        ...
                        <div class="col right">
                            <p class="intro"> We have partnered with MoneyGram, Swift, and Flex to provide local and international money transfer services. Simply walk into your nearest Co-op Bank branch and transact at the dedicated money transfer counter.</p>
