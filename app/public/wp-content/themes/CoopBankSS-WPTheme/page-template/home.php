            ...
            <div class="col centre">
                <div class="home-banner-content">
                    <h1>Welcome to Co-operative Bank South Sudan
                        <span class="centre">Bringing about economic empowerment to the people of South Sudan.</span>
                    </h1>

                    <h2>Let’s get you started</h2>
                    <ul class="cards">
                        <li>
                            <a href="https://clients.belva.co.ke/co-opbankss/foreign-exchange/">
                        ...
                        <li>
                            <a href="https://clients.belva.co.ke/co-opbankss/accounts/ngo-account/">
                                <div class="block equal-height">
                            <span class="icn centre">
                        ...
                        <li>
                            <a href="https://clients.belva.co.ke/co-opbankss/money-transfer/cash-transfer-services-cit/">
                                <div class="block equal-height">
                            <span class="icn centre">
                        ...
                        <li>
                            <a href="https://clients.belva.co.ke/co-opbankss/money-transfer/">
                                <div class="block equal-height">
                            <span class="icn centre">
