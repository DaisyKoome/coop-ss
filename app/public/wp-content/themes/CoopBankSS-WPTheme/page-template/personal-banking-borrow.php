...
/**
 *
 * Template Name: Personal Banking Borrow
 *
                    ...
                    <div class="tbl">
                        <div class="col left">
                            <div class="caption-menu">
                                <ul>
                                    <li ><a href="<?php echo home_url('/personal-banking/'); ?>" ><span>Accounts</span></a></li>
                                    <li class="active"><a href="<?php echo home_url('/personal-banking/borrow/'); ?>" ><span>Borrow</span></a></li>
                        ...
                        <div class="col right">
                            <p class="intro"> We offer a range of loans tailored to suit your specific needs.</p>
