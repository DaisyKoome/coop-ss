...
/**
 *
 * Template Name: Business Banking Borrow
 *
                    ...
                    <div class="tbl">
                        <div class="col left">
                            <div class="caption-menu">
                                <ul>
                                    <li ><a href="<?php echo home_url('/business-banking/'); ?>" ><span>Accounts</span></a></li>
                                    <li class="active"><a href="<?php echo home_url('/business-banking/borrow/'); ?>" ><span>Borrow</span></a></li>
